...
function MQTT.client:connect(                                     -- Public API
  ...
  --MQTT.Utility.debug("Log socket.connect: ")
  --MQTT.Utility.debug(string)
...
function MQTT.client:handler()                                    -- Public API
  if (self.connected == false) then
    return("MQTT.client:handler(): Not connected")
  end
...
function MQTT.client:subscribe(                                   -- Public API
  ...
  if (self.connected == false) then
    return("MQTT.client:subscribe(): Not connected")
  end
